    ...
    <div class="userList_content">
      ...
      <div class="userList">
        ...
        >
          ...
          ></el-table-column>
          <el-table-column align="center" prop="managerName" label="管理员" width="150"></el-table-column>
          <el-table-column align="center" prop="sum" label="团队人数" width="180"></el-table-column>
          <el-table-column
            align="center"
            prop="dmoney"
            label="佣金总数"
            ...
            :show-overflow-tooltip="true"
          ></el-table-column>
          <el-table-column align="center" prop="slogan" label="口号" :show-overflow-tooltip="true"></el-table-column>
      ...
      <!-- 编辑用户信息列表 -->
      <el-dialog width="400px" title="用户信息" class="team_allTable" :visible.sync="edit">
        <el-form
