...
import { findAllTaxonomys, delTaxonomyById,delTaxonomyByIds } from "../../../network/commodity";
export default {
  components: {},
  data() {
    return {
  ...
  methods: {
    ...
    gotoAdd() {
      this.$router.push({ path: "/commodity/tag/add" });
    },
    gotoCredits(res) {
