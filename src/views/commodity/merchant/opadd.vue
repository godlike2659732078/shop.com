    ...
    <div class="addExchange">
      ...
      >
        ...
        <div style="padding-left: 50px">
          ...
          <el-form-item label="可用积分：" prop="integralsId">
            <el-select
              v-model="value1"
              @change="a"
              multiple
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        integralsId: [{ required: true, message: "必填项不能为空" }],
  ...
  created() {
    this.addForm.goodId = this.$route.query.id;
    this.addForm.offlineId = this.$route.query.sId;
    let obj = {};
