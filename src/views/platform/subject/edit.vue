...
import { findArticlesById,editArticlesById } from "../../../network/platform";
...
export default {
  ...
  created() {
    ...
    findArticlesById(obj).then((res) => {
    //console.log(res.data);
      this.addForm = res.data;
      this.addForm.isPopular=res.data.isPopular.toString()
