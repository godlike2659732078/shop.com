    ...
    <div class="userList_content">
      ...
      <div class="userList">
        ...
        >
          ...
          <el-table-column align="center" prop="storeName" label="商铺名称" width="150"></el-table-column>
          ...
          <el-table-column align="center" prop="userType" label="身份" width="100">
            <template slot-scope="scope">
              <el-button
          ...
          <el-table-column align="left" prop="storeAddress" label="地址"></el-table-column>
          <el-table-column
            align="createTime"
            label="添加时间"
            prop="createTime"
...
import { getBarter } from "../../../network/merchant";
export default {
  components: {},
  data() {
    return {
